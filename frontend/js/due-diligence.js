...
// maskCpf, fmtCnpj) — compartilhadas com due-diligence2.js. Os nomes ddXxx
// seguem existindo como atalhos porque o HTML (due-diligence-view.html)
// chama por esses nomes nos atributos oninput/onblur.
function ddSoAlfanum(v){return soAlfanum(v);}
function ddMC(v){return maskCnpj(v);}
function ddMCpf(v){return maskCpf(v);}
function ddFmt(n){return fmtCnpj(n);}
